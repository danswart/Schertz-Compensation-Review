...
# Step 3: Impute benefits for FY20-FY22
all_data <- all_data |>
  dplyr::mutate(
    # Flag imputed rows
...
imputation_summary |>
  ...
  dplyr::rename(
    ...
    `Employees` = employees,
    `Regular Earnings` = total_regular,
    `Add'l Benefits` = total_benefits,
    `Total Comp` = total_comp,
    `Benefits as % of Reg Earnings` = benefits_pct
  ) |>
  flextable::flextable() |>
  ...
  flextable::bg(i = 1, bg = "white", part = "header") |>
  flextable::bg(i = 2, bg = "palegreen", part = "header") |>
  flextable::bg(i = ~ grepl("Imputed", `Imputed?`), bg = "#ffffcc") |>
  flextable::autofit()
```
...
ggplot2::ggplot(yearly_summary, 
  ...
  ggplot2::labs(
    title = "Total Employee Compensation Growth by Fiscal Year - All Depts",
    subtitle = "City of Schertz",
    x = "Fiscal Year",
