...
### Plot: Compensation Growth by Department (Top 10)
...
ggplot2::ggplot(dept_yearly, ggplot2::aes(x = fiscal_year, y = total_compensation, 
                                           fill = department)) +
  ggplot2::geom_col(position = "stack") +
  ggplot2::scale_y_continuous(labels = scales::dollar_format(scale = 1e-6, suffix = "M")) +
  ggplot2::labs(
    title = "Total Compensation by Department (Top 10)",
    subtitle = "Stacked view shows which departments are driving growth",
    x = "Fiscal Year",
    y = "Total Compensation",
    fill = "Department"
  ) +
